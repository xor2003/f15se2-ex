...
extern const char emptyMissTypeNames[3] = {0, 0, 0};
extern const char emptyMissTypeDescs[3] = {0, 0, 0};
extern const char emptyHistDesc1 = 0;
extern const char emptyHistDesc2 = 0;
...
extern const char aOpenError[] = ":Open error $";
extern const char aFileClosingError[] = "File closing error$";
extern const char aReadError[] = "Read error$";
extern const char aWriteError[] = "Write error$";
...
extern const int16 targetCoordsX0[3] = {17856, 15680, 3520};
extern const int16 targetCoordsY0[3] = {15552, 17216, 9408};
extern const int16 targetCoordsX1[2] = {9920, 10048};
extern const int16 targetCoordsY1[2] = {8512, 8640};
extern const int16 targetCoordsX2[2] = {15808, 9664};
extern const int16 targetCoordsY2[2] = {17344, 15296};
extern const int16 targetCoordsX3[3] = {8448, 2304, 4352};
extern const int16 targetCoordsY3[3] = {8960, 2304, 1280};
extern const int16 targetCoordsX4[4] = {12032, 6912, 15616, 5376};
extern const int16 targetCoordsY4[4] = {11008, 4864, 11520, 13568};
extern const int16 targetCoordsX5 = 23232;
extern const int16 targetCoordsY5 = 15040;
...
extern const int16 targetCoordsX7[3] = {19776, 19520, 19776};
extern const int16 targetCoordsY7[3] = {14656, 14784, 14784};
