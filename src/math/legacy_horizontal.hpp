...
using Horizontal = HorizontalBoundary<FixedBackend>;
...
template<class Axis> inline std::int32_t fineUnits(ViewCoordinate<FixedBackend, Axis> v) { return Horizontal::coordinate(v); }
}
#endif
