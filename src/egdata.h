...
extern char aStoresExhauste[];
extern char aFlare[];
extern char aChaff[];
extern char aReleased[];
...
extern char aLandingGearRaised[];
extern char aBrakesOn[];
extern char a_[];
extern char aG[];
...
extern char aFiring[];
extern char aFiredBy[];
extern char aTakingOff[];
extern char aDash[];
extern char aColon[];
extern char aEmpty_5950[];
extern char aMisses[];
extern char aDestroyedBy[];
extern char aDestroyedBy_0[];
extern char aGroundImpact[];
extern char aHitBy[];
extern char aIneffective[];
extern char aHitBy_0[];
...
extern char aMedium[];
extern char aShort[];
extern char aRangeRadar[];
extern char aDetailLevel[];
extern char aKybdSensitivit[];
extern char aMemoryAvailabl[];
extern char aJiffiesFrame[];
extern char aSounds[];
extern char aDirector[];
extern char aOff[];
extern char aWaypointPrimar[];
extern char aWaypointSecond[];
extern char aWaypointFriend[];
extern char aAutopilotOff[];
extern char aAutopilotOn[];
extern int16 g_axisInputAccum[];
extern char aNotAvailable[];
extern char aArmed[];
