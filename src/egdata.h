...
extern f15::math::FineRep<f15::math::GameBackend> g_projInterpX[];
extern f15::math::FineRep<f15::math::GameBackend> g_projInterpY[];
...
extern f15::math::TickDuration g_threatActiveTimer;
extern int16 g_airTargetLock;
extern int16 g_groundTargetLock;
extern int16 g_smokeSourceIdx;
extern f15::math::TickDuration g_scopeSweepTimer;
...
extern f15::math::TickDuration g_landingTimer;
...
extern uint16 buf3d3[MODEL_SLOT_CAPACITY];
extern unsigned int size3d3_2;
extern int16 sign3dt;
extern uint16 sizes3dt[];
#include "model_limits.h"
extern uint16 matrix3dt[5][TERRAIN_TILE_PATTERN_CAPACITY];
...
extern f15::math::Matrix3<f15::math::GameBackend> g_orientMatrix;
extern f15::math::Matrix3<f15::math::GameBackend> g_matrixScratch;
extern f15::math::Angle<f15::math::GameBackend> g_ourHead;
extern f15::math::Angle<f15::math::GameBackend> g_ourPitch;
extern f15::math::Angle<f15::math::GameBackend> g_ourRoll;
...
extern f15::math::TickDuration g_rotationCounter;
extern f15::math::TickDuration g_lastSpawnTick;
extern int16 g_radarScopeRange;
extern int16 g_mapCenterX;
extern int16 g_mapCenterY;
extern f15::math::TickDuration g_hudMsgTimer;
extern f15::math::TickDuration g_dirMsgTimer;
...
extern char aLeft[];
extern char aMap[];
extern char aDestroyedByGun[];
extern char aHitByGunfire[];
extern char aDestroyedByG_0[];
extern char aAt_0[];
extern char egPrimaryTarget[];
extern char aSecondaryTarget[];
extern char aNoTarget[];
extern char aNoTarget_0[];
...
extern f15::math::Angle<f15::math::GameBackend> g_rollPitchTrim;
...
extern f15::math::TickDuration g_missionTick;
...
extern f15::math::WordRep<f15::math::GameBackend> g_attackRangeX;
extern uint8 buf4_3dg[];
extern int16 g_playerPlaneFlags;
extern f15::math::WordRep<f15::math::GameBackend> g_attackRangeY;
extern uint8 buf3_3dg[];
extern int16 g_targetInHudFlag;
extern int16 g_lockedTargetKilled;
extern f15::math::TickDuration g_hitEffectTimer;
...
extern f15::math::FlightSpeed<f15::math::GameBackend> g_velocity;
extern int16 g_enemyThreatCount;
extern int16 g_camRotMatrix[];
extern struct ViewSnapshot g_viewSnapshotRing[];
extern f15::math::CornerSpeed<f15::math::GameBackend> g_knots;
...
extern f15::math::EngineThrust<f15::math::GameBackend> g_thrust;
extern int16 g_northSouthSign;
extern int16 g_unusedViewYSnap;
extern uint8 g_mapCellFlags[];
extern f15::math::TickDuration g_threatTimerInit;
...
/* Same shadow contract for the packed int16 alt/speed words — the shadow is
 * WordRep (int16 fixed / double modern) so per-tick alt/speed integration
 * keeps the fraction under modern. */
extern f15::math::WordRep<f15::math::GameBackend> g_simObjectAlt[];
extern f15::math::WordRep<f15::math::GameBackend> g_simObjectSpeed[];
extern f15::math::TickDuration g_aamLockCooldown;
...
extern f15::math::RollCommand<f15::math::GameBackend> g_rollInput;
...
extern f15::math::FineRep<f15::math::GameBackend> g_viewTargetX;
extern int16 g_loftTargetIdx;
extern f15::math::FineRep<f15::math::GameBackend> g_viewTargetY;
...
extern f15::math::ClimbRate<f15::math::GameBackend> g_climbRate;
...
extern int16 g_viewPosFracX;
extern int16 g_viewPosFracY;
extern int16 g_viewPosFracZ;
extern int16 g_camEyeFracX;
extern int16 g_camEyeFracY;
extern int16 g_camEyeFracZ;
...
extern f15::math::TickDuration g_fireCooldown;
...
extern f15::math::Angle<f15::math::GameBackend> g_trkBearing;
extern int16 g_trkSize;
extern int16 g_trkScale;
extern f15::math::Angle<f15::math::GameBackend> g_trkPitch;
extern f15::math::Angle<f15::math::GameBackend> g_trkRoll;
